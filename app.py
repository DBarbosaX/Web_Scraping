...
def web():
    if request.method == 'POST':
        ...
        data_inicial = datetime.datetime.strptime(request.form['datainicial'], "%Y-%m-%d").date().strftime("%m%d%Y")
        data_final = datetime.datetime.strptime(request.form['datafinal'], "%Y-%m-%d").date().strftime("%m%d%Y")
        print (software)
        print (data_inicial)
        print (data_final)
